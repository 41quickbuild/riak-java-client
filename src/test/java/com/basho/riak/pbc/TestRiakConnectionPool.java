...
public class TestRiakConnectionPool {
    ...
    @Test public void poolConnectionCountChecks() throws Exception {
        ...
        int idleConnectionTTL = 100;
        RiakConnectionPool pool = new RiakConnectionPool(1, semaphore, idleConnectionTTL, 5000, mockRiakConnectionFactory);
        pool.start();
        ...
        try {
            ...
            Thread.sleep(2 * idleConnectionTTL);
            assertPoolState(pool, 2, 0);
